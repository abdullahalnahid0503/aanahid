<template>
  ...
  class="group relative w-full h-10 flex items-center justify-center rounded-full text-sm font-medium overflow-hidden transition-all duration-300"
  ...
  setup(props) {
    ...
    const currentComponent = () => {
      switch (currentTopic.value.toLowerCase()) {
        ...
        case 'public-transportation': return PublicTransportation
        ...
        case 'healthcare-insurance': return HealthcareInsurance
