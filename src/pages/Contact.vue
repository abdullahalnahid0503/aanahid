    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div class="space-y-8">
          ...
          <div
  class="bg-gradient-to-br from-primary/10 to-blue-500/10
         backdrop-blur-sm
...
>
  ...
  <p class="text-zinc-400 text-sm text-justify">
              ...
              <br><br>Whether it’s a new project, a collaboration, or an opportunity to create impact, I’m all ears, and I promise to bring curiosity and energy. If your idea involves connecting people, solving global challenges, or making learning more inclusive and ethical, we’re probably on the same page.
...
<div class="bg-zinc-900/50 backdrop-blur-sm rounded-xl shadow-lg p-8 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
  ...
  <div class="space-y-4">
    ...
    <a href="https://www.linkedin.com/in/abdullahalnahid0503/" target="_blank"
      ...
      <svg class="w-6 h-6 text-primary" fill="white" viewBox="0 0 24 24">
